...
class CardControllerTest extends AbstractIntegrationTest {
  ...
  void createCardTest() {
    String payload =
"""
{"userId":currentUserId,"number":"123456789","holder":"CardHolder","dateEx":"2022-02-16T10:22:15"}
        """;
  ...
  void createCardsTest() {
    String payload =
        """
  [{"userId":currentUserId,"number":"111111","holder":"CardHolder","dateEx":"2022-02-16T10:22:15"},
  {"userId":currentUserId,"number":"222222","holder":"CardHolder","dateEx":"2022-02-16T10:22:15"}]
          """;
    payload = payload.replace("currentUserId", "" + userId);
  ...
  void updateCardTest() {
    ...
    String payload =
        """
  {"userId":currentUserId,"number":"987654","holder":"CannotChangeCardHolder","dateEx":"2022-02-16T10:22:15"}
          """;
    payload = payload.replace("currentUserId", "" + userId);
  ...
  void testDeleteCustomer() {
    User userToDel = new User(null, "John", "Connor", LocalDateTime.now(), "tomjohn@mail.com");
